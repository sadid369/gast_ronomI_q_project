...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bread.png
  AssetGenImage get bread => const AssetGenImage('assets/icons/bread.png');
  ...
  /// File path: assets/icons/ellipsis_white.svg
  SvgGenImage get ellipsisWhite =>
      const SvgGenImage('assets/icons/ellipsis_white.svg');
  ...
  /// File path: assets/icons/forward_view.svg
  SvgGenImage get forwardView =>
      const SvgGenImage('assets/icons/forward_view.svg');

  /// File path: assets/icons/forward_white.svg
  SvgGenImage get forwardWhite =>
      const SvgGenImage('assets/icons/forward_white.svg');

  /// File path: assets/icons/fruits.svg
  SvgGenImage get fruits => const SvgGenImage('assets/icons/fruits.svg');
